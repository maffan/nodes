 ...
 */
@Embeddable
public class NodetypePK implements Serializable {
    ...
    public NodetypePK(String node, String owner) {
        this.node = node;
        this.owner = owner;
    }
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof NodetypePK)) {
            return false;
        }
        NodetypePK other = (NodetypePK) object;
    ...
    public String toString() {
        return "se.nomorebagels.entities.NodetypePK[ node=" + node + ", owner=" + owner + " ]";
    }
